	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","background":"url(http://codegen.caihongy.cn/20230401/bd196cf1072f48afae5676066a72e297.jpg) fixed no-repeat center top / 100% 100%"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="课程标题" prop="kechengbiaoti">
					<el-input v-model="ruleForm.kechengbiaoti" placeholder="课程标题" clearable  :readonly="ro.kechengbiaoti"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="课程标题" prop="kechengbiaoti">
					<el-input v-model="ruleForm.kechengbiaoti" placeholder="课程标题" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="课程类型" prop="kechengleixing">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.kechengzhaopian" label="课程照片" prop="kechengzhaopian">
					<file-upload
						tip="点击上传课程照片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.kechengzhaopian" label="课程照片" prop="kechengzhaopian">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="授课教练" prop="shoukejiaolian">
					<el-input v-model="ruleForm.shoukejiaolian" placeholder="授课教练" clearable  :readonly="ro.shoukejiaolian"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="授课教练" prop="shoukejiaolian">
					<el-input v-model="ruleForm.shoukejiaolian" placeholder="授课教练" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.kechengjianjie" label="课程简介" prop="kechengjianjie">
					<span :style='{"fontSize":"16px","lineHeight":"40px","color":"#666","fontWeight":"500","display":"inline-block"}'>{{ruleForm.kechengjianjie}}</span>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.kechengxiangqing" label="课程详情" prop="kechengxiangqing">
                    <span :style='{"fontSize":"16px","lineHeight":"40px","color":"#666","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.kechengxiangqing"></span>
                </el-form-item>
...
export default {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='kechengzhaopian'){
							this.ruleForm.kechengzhaopian = obj[o];
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.kechengxiangqing = this.ruleForm.kechengxiangqing.replace(reg,'../../../ssmbgnk6/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
...
var objcross = this.$storage.getObj('crossObj');
    ...
    kechengzhaopianUploadChange(fileUrls) {
	    this.ruleForm.kechengzhaopian = fileUrls;
    },
  }
};
</script>
